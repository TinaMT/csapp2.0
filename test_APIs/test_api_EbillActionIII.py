...
from api_objects.EbillActionIIIAPIs import ebillActionIIIAPIs
from utils.object_utils import ObjectUtils

# EXCEL 路徑
file_path = r'test_data/AllAPIs.xlsx'
sheet_name = '131_ebillActionIIIAPIs'
data_dicts = process_excel_data(file_path, sheet_name)

@pytest.mark.parametrize('data_dict', data_dicts)
def test_api_ebillActionIIIAPIs_success(data_dict, get_session):
    ...
    try:
        ...
        ebillActionIII_apis = ebillActionIIIAPIs(get_session)
 
        request_params = json.loads(request_params)
        response = ebillActionIII_apis.get_data_info(request_params)
